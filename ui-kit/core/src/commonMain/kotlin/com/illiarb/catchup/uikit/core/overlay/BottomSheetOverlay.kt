package com.illiarb.catchup.uikit.core.overlay

/**
 * Copied from https://github.com/slackhq/circuit/blob/main/circuitx/overlays/src/commonMain/kotlin/com/slack/circuitx/overlays/BottomSheetOverlay.kt
 * due to https://github.com/slackhq/circuit/issues/1569
 */
...
public class BottomSheetOverlay<Model : Any, Result : Any> private constructor(
  ...
  public constructor(
    ...
    properties =
    createBottomSheetProperties(shouldDismissOnBackPress = false),
    content = content,
  )
